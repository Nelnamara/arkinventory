...
--	restack
	...
	L["RESTACK_MODIFIER"] = "Require Modifier Key"
	L["RESTACK_MODIFIER_DESC"] = "Require a modifier key to be held when left-clicking the Restack button (prevents accidental restacks)"
	L["RESTACK_MODIFIER_NONE"] = "None (no modifier required)"
	L["RESTACK_MODIFIER_SHIFT"] = "Shift"
	L["RESTACK_MODIFIER_CTRL"] = "Ctrl"
	L["RESTACK_MODIFIER_ALT"] = "Alt"
	L["RESTACK_MODIFIER_WARN"] = "Hold %s to restack"
